...
public class Article {
	...
	public Article(Long srNo, String articleId, String title, String content, Status status, LocalDateTime creationDate,
			Date lastModifiedDate, Integer currentVersionId, Long userId) {
		super();
		this.srNo = srNo;
